...
return (
    <div id="projectWrap" className="row justify-content-center" style={{ position: 'relative', zIndex: '2'}}>
            {/* EquityX */}
            <div id="project1" className="project mx-3 projectCard mb-3 mt-3 px-4  " >
                <div id="projectHead1">
                    ...
                    <a class="text-center lightGreenFont" href="http://13.59.191.93/" target="_blank" rel="noreferrer">Deployed site</a></div>
                ...
                <div id="projectInfo1">
                    ...
                    <p className="card-text"> Collaborators: None | <a target="_blank" rel="noreferrer" href="https://github.com/trinhgliedt/equityX" className="card-link">GitHub Link</a> </p>
                    </div>
                </div>
            </div>
            {/* SunFlowers */}
            <div id="project2" className="project mx-3 projectCard mb-3 mt-3 px-4 " >
                <div id="projectHead2">
                    <h5 className="mt-3 mb-0 text-center projectHeader">Sunflowers - Clothes shopping made easy</h5>
                    <div className="row d-flex justify-content-center mb-2">
                    <a class="text-center lightGreenFont" href="http://18.191.91.140/" target="_blank" rel="noreferrer">Deployed site</a></div>
                    <video width="100%"  controls>
            ...
            {/* AQI Maps */}
            <div id="project3" className="project mx-3 projectCard mb-3 mt-3 px-4 ">
                <div id="projectHead3">
            ...
            {/* Let's Meet */}
            <div id="project4" className="project mx-3 projectCard mb-3 mt-3 px-4 ">
                <div id="projectHead4">
